...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 02-Mar-2020 às 18:57
...
CREATE TABLE IF NOT EXISTS `anime_users` (
  ...
  `userEdit` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`),
  KEY `animeID` (`animeID`),
  KEY `userID` (`userID`)
...
INSERT INTO `anime_users` (`ID`, `animeID`, `userID`, `userStatus`, `userScore`, `userEpisodes`, `userEdit`) VALUES
(1, 1, 1, 2, 10, 24, '2020-02-29 22:03:27'),
(2, 5, 1, 2, 7, 37, '2020-03-02 18:44:17'),
(3, 4, 1, 1, 8, 0, '2020-03-02 18:44:10'),
(4, 5, 2, 1, 9, 0, '2020-03-02 18:47:41');
...
INSERT INTO `manga_users` (`ID`, `mangaID`, `userID`, `userStatus`, `userScore`, `userChapters`, `userVolumes`, `userEdit`) VALUES
(1, 1, 1, 2, 10, 208, 25, '2020-02-29 19:45:08'),
(2, 2, 1, 1, 10, 75, 8, '2020-02-29 20:26:24');
...
(1, 'ThiagoIanuch', 'thiagoianuch@hotmail.com', '$2y$10$2p7NAzb.oaq4UaCiI./6c.AeKOev2AzM.3a4rlnW004XDqimJw0yC', 1, 0x586a59515574382e706e67, 0x616e696d652d77616c6c70617065722e6a7067, 0x73756e726973652d616e696d652d6769726c2d73696c686f75657474652d7363656e6572792d75686470617065722e636f6d2d68642d342e3632382e6a7067, 'こんにちは、ようこそ。私の名前はチアゴです。', 1, '2002-09-15', 'Brasil', '2020-02-28'),
(2, 'ThiagoIM', 'thiago.ianuch@hotmail.com', '$2y$10$Rs8Moy/W7M6mIeii7v1P8.RY9FD9d/hnmZ4o0J.mh0nAgyZnreAz.', 0, 0x3631353133322e6a7067, 0x68617473756e652d6d696b752d616e696d652d766f63616c6f69642d6769726c2d77616c6c70617065722e6a7067, 0x77616c6c7061706572322e706e67, NULL, 0, NULL, NULL, '2020-02-28');
